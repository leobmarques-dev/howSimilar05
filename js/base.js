...
// -----------------------------------------------------------------------------------------------
    ...
    var userName = $("#dataSource  option:selected").val();
// ===============================================================================================
...
// -----------------------------------------------------------------------------------------------------------
            ...
            var saidaResultadoAnalise = new DefineParametrosAnalise(cabecalhoDados, respostasDados, distEntrePalavras, outputType, userName);
