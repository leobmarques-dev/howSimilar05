...
// ------------------------------------------------------- //
  ...
  /**
    This is a variation of the Damerau-Levenshtein distance that returns the strings' edit distance taking into account 
    deletion, insertion, substitution, and transposition, under the condition that no substring is edited more than once.

    For example, optimalStringAlignmentDistance('ca', 'abc') == 3 because if the transposition 'ca' -> 'ac' is used, 
    it is not possible to use the insertion 'ac' -> 'abc'. The shortest sequence of operations is 'ca' -> 'a' -> 'ab' -> 'abc'.
  **/
    ...
    // Return the strings' distance
    return d[m][n];
  } // END - optimalStringAlignmentDistance
// ------------------------------------------------------- //